...
define( "RECIPIENT_NAME", "Support Team" );
define( "RECIPIENT_EMAIL", "3codesolutions@gmail.com" );
...
if ( $senderName && $senderEmail && $senderPhone && $senderSubject && $message) {
  $recipient = RECIPIENT_NAME . "Support Team" . RECIPIENT_EMAIL . "3codesolutions@gmail.com";
